...
class Component(models.Model):
    ...
    id_applicationsystem = models.ForeignKey('ApplicationSystem', models.DO_NOTHING, db_column='id_applicationsystem', blank=True, null=True)
...
class RelVapplicationsystemVcomponent(models.Model):
    rel_applicationsystem_vcomponent = models.AutoField(primary_key=True)
    id_vapplicationsystem = models.ForeignKey('Vapplicationsystem', models.DO_NOTHING, db_column='id_vapplicationsystem', blank=True, null=True)
    id_vcomponent = models.ForeignKey('Vcomponent', models.DO_NOTHING, db_column='id_vcomponent', blank=True, null=True)
    owner_applicationsystem_vcomponent = models.IntegerField(blank=True, null=True)
    comment_applicationsystem_vcomponent = models.CharField(max_length=255, blank=True, null=True)
...
class RelVsystemVapplicationsystem(models.Model):
    rel_vsystem_vapplicationsystem = models.AutoField(primary_key=True)
    id_vsystem = models.ForeignKey('Vsystem', models.DO_NOTHING, db_column='id_vsystem', blank=True, null=True)
    id_vapplicationsystem = models.ForeignKey('Vapplicationsystem', models.DO_NOTHING, db_column='id_vapplicationsystem', blank=True, null=True)
    comment_vsystem_vapplicationsystem = models.CharField(max_length=255, blank=True, null=True)
...
class ApplicationSystem(models.Model):
    id_applicationsystem = models.AutoField(primary_key=True)
    name_applicationsystem = models.CharField(max_length=255, blank=True, null=True)
    owner_applicationsystem = models.ForeignKey(Engineer, on_delete=models.DO_NOTHING, blank=True, null=True)
    system = models.ForeignKey('System', models.DO_NOTHING,  blank=True, null=True)

    def __str__(self):
        return self.name_applicationsystem
...
class System(models.Model):
    ...
    systemofsystem = models.ForeignKey('Systemofsystem', models.CASCADE, blank=True, null=True)
...
class Systemofsystem(models.Model):
    ...
    owner_systemofsystem = models.ForeignKey(Engineer, on_delete=models.DO_NOTHING, blank=True, null=True)
...
class Vapplicationsystem(models.Model):
    id_vapplicationsystem = models.AutoField(primary_key=True)
    version_vapplicationsystem = models.IntegerField(blank=True, null=True)
    owner_vapplicationsystem = models.ForeignKey(Engineer, models.DO_NOTHING, db_column='owner_vapplicationsystem', blank=True, null=True)
    date_vapplicationsystem = models.DateTimeField(blank=True, null=True)
    applicationsystem = models.ForeignKey(ApplicationSystem, models.DO_NOTHING, db_column='id_applicationsystem', blank=True, null=True)
    comment_vapplicationsystem = models.CharField(max_length=255, blank=True, null=True)
...
class Vsystem(models.Model):
    ...
    system = models.ForeignKey(System, models.DO_NOTHING, db_column='id_system', blank=True, null=True)
...
class Vsystemofsystem(models.Model):
    ...
    systemofsystem = models.ForeignKey(Systemofsystem, models.DO_NOTHING, db_column='id_systemofsystem', blank=True, null=True)
...
# Customized models -- create for demo
...
class RelInputParameter(models.Model):
    vsystem = models.ForeignKey(Vsystem, on_delete=models.DO_NOTHING, null=False)
    vapplicationsystem = models.ForeignKey(Vapplicationsystem, on_delete=models.DO_NOTHING, null=False)
    inputparameter = models.ForeignKey(InputParameter, on_delete=models.DO_NOTHING, null=False)
    value = models.CharField(max_length=100, blank=False, default='')

    def __str__(self):
        return self.vsystem.system.name_system + ':' + str(self.vsystem.version_vsystem) + '-' + self.vapplicationsystem.applicationsystem.name_applicationsystem + '-' + self.inputparameter.name + ': ' + self.value 

    def save(self, *args, **kwargs):
        if (self.inputparameter.type_value == 'number') and (not str.isdigit(self.value)):
            raise ValidationError({'Entered value is not a number!!!'})
        else:
            super(RelInputParameter, self).save(*args, **kwargs)


class OutputParameter(models.Model):
    name = models.CharField(max_length=100, blank=False, null=False)
    label = models.CharField(max_length=120, blank=False, null=False)
    type_value = models.CharField(max_length=10, choices=TYPE_CHOICES, default="NUMBER")
